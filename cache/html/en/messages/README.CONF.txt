TITLE WWWOFFLE - Configuration File - Version 2.8c
HEAD
...
If a request is made for a page that contains a username and password then a request is made for the same page without a username and password specified (default=yes).  This allows for requests for the page without a password to re-direct the client to the passworded version.
