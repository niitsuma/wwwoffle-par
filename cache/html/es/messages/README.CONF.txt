...
Usa las modificaciones de esta sección tanto cuando está conectado como cuando está desconectado (por defecto=no).  El HTML o los GIF no aparecerán en el navegador hasta que WWOFFLE los haya procesado. Esta opción no se aplica sobre páginas marcadas para que no se  almacenen.
SECTION LocalHost
